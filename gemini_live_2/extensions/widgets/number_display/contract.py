...
WIDGET_EXTENSION = WidgetDefinition(
    validate_props=_validate_props, anchor_policy=lambda _: (WidgetAnchor("number", ("highlight", "circle")),),
    ...
    state_fields=(_VISIBILITY,), stage_map_policy=StageMapPolicy(kind="number_display", content_label="SỐ", text_source="props.value", anchor_key="number"), declared_effect_ids=("highlight", "circle"),
)
