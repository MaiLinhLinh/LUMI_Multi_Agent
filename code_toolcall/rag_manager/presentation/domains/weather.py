...
from ..planner import fallback_presentation_plan
from ..prompts import WEATHER_PRESENTATION_SYSTEM
from ..schemas import GroundedFact, PresentationPlan

_TARGET_ID_RE = re.compile(r"^[a-z][a-z0-9._-]*$")


class WeatherPresentationAdapter(PresentationDomainAdapter):
    domain_id = "weather"
    system_instruction = WEATHER_PRESENTATION_SYSTEM
