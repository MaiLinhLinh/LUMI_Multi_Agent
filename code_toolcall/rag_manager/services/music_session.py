...
class MusicSessionManager:
    ...
    def _match_named_candidate(
        ...
        for index, candidate in enumerate(
            ...
            if stripped in aliases or normalized_query in aliases or any(
                _alias_is_whole_phrase_in_query(alias, normalized_query)
...
def _alias_is_whole_phrase_in_query(alias: str, query: str) -> bool:
    """A high-confidence phrase match that preserves title words such as 'đi'."""
